...
codes = [{"code":"16700","system":"gprdproduct"},{"code":"18461","system":"gprdproduct"},{"code":"26498","system":"gprdproduct"},{"code":"44251","system":"gprdproduct"},{"code":"8322","system":"gprdproduct"}];
REQUIRED_CODES = 1;
